// =====================================================================
// Oseias — tradução do hebraico (versificação: Nova Vulgata)
// Formato: {s:"subtítulo"} abre trecho; {v,t,n} prosa; {v,l:[...]} verso;
// np:1 marca início de parágrafo (nos poemas, de estrofe).
// =====================================================================

window.TEXTOS_SEED["oseias"][1] = [
{s:"Título do livro"},
{v:1,t:"Palavra do Senhor dirigida a Oseias, filho de Beeri, no tempo de Ozias, Joatão, Acaz e Ezequias, reis de Judá, e no tempo de Jeroboão, filho de Joás, rei de Israel.",n:"Oseias pregou no reino do norte, Israel, entre 750 e 725 antes de Cristo, pouco antes da queda de Samaria."},
{s:"A mulher e os filhos do profeta"},
{v:2,l:["Começo da palavra do Senhor por meio de Oseias. O Senhor disse a Oseias:","Vai, toma para ti uma mulher de prostituição","e filhos de prostituição,","porque a terra se prostitui, afastando-se do Senhor."],n:"Nota do tradutor: o casamento do profeta é um sinal da infidelidade de Israel, que abandona o Senhor pelos ídolos; o texto não foi suavizado."},
{v:3,t:"Ele foi e tomou Gomer, filha de Diblaim, que concebeu e lhe deu um filho.",np:1},
{v:4,t:"O Senhor lhe disse: Dá-lhe o nome de Jezrael, porque daqui a pouco castigarei a casa de Jeú pelo sangue derramado em Jezrael e porei fim ao reino da casa de Israel;",np:1,n:"Jezrael: lugar dos massacres com que Jeú tomou o poder (2 Reis 9–10); o nome significa Deus semeia (compare 2,24–25)."},
{v:5,t:"naquele dia quebrarei o arco de Israel no vale de Jezrael."},
{v:6,t:"Ela concebeu de novo e deu à luz uma filha; e o Senhor lhe disse: Dá-lhe o nome de Sem-Misericórdia, porque não terei mais compaixão da casa de Israel, para lhe perdoar.",np:1,n:"Em hebraico, Lo-Ruhamá."},
{v:7,t:"Mas terei compaixão da casa de Judá e a salvarei pelo Senhor, seu Deus; não a salvarei pelo arco, nem pela espada, nem pela guerra, nem pelos cavalos, nem pelos cavaleiros.",np:1},
{v:8,t:"Depois de desmamar Sem-Misericórdia, ela concebeu e deu à luz um filho.",np:1},
{v:9,t:"E o Senhor disse: Dá-lhe o nome de Não-Meu-Povo, porque vós não sois o meu povo, e eu não sou para vós o Eu Sou.",np:1,n:"Em hebraico, Lo-Ami. O Eu Sou: alusão ao nome divino revelado a Moisés (Êxodo 3,14)."}
];

window.TEXTOS_SEED["oseias"][2] = [
{s:"Promessa de restauração"},
{v:1,l:["O número dos filhos de Israel será","como a areia do mar,","que não se pode medir nem contar.","E no lugar onde lhes diziam:","Vós não sois o meu povo,","lhes dirão: Filhos do Deus vivo."],n:"Em outras Bíblias, 2,1–2 é 1,10–11, e a numeração deste capítulo diminui de duas unidades. Compare Romanos 9,25–26."},
{v:2,l:["Os filhos de Judá e os filhos de Israel","se reunirão","e escolherão para si um só chefe,","e subirão da terra,","pois grande será o dia de Jezrael."],np:1},
{v:3,l:["Dizei aos vossos irmãos: Meu-Povo,","e às vossas irmãs: Misericórdia-Alcançada."],np:1},
{s:"A esposa infiel"},
{v:4,l:["Acusai a vossa mãe, acusai-a,","pois ela não é minha mulher,","e eu não sou o seu marido;","que ela afaste do seu rosto as suas prostituições","e dos seus seios os seus adultérios,"]},
{v:5,l:["para que eu não a despoje e a deixe nua","como no dia em que nasceu,","a torne como um deserto,","a deixe como uma terra árida","e a faça morrer de sede."],np:1},
{v:6,l:["Não terei compaixão dos seus filhos,","porque são filhos de prostituição,"],np:1},
{v:7,l:["pois a mãe deles se prostituiu,","desonrou-se aquela que os concebeu;","ela disse: Irei atrás dos meus amantes,","que me dão o meu pão e a minha água,","a minha lã e o meu linho,","o meu azeite e a minha bebida."],np:1},
{v:8,l:["Por isso eis que vou fechar","o teu caminho com espinhos","e levantar um muro contra ela,","e ela não encontrará as suas veredas;"],np:1},
{v:9,l:["correrá atrás dos seus amantes,","mas não os alcançará;","irá procurá-los, mas não os encontrará;","e dirá: Vou voltar","para o meu primeiro marido,","pois então eu vivia melhor do que agora."],np:1},
{v:10,l:["Ela não reconheceu que era eu","quem lhe dava o trigo, o vinho novo e o azeite,","quem lhe multiplicava a prata","e o ouro, que usaram para Baal."],np:1},
{v:11,l:["Por isso voltarei atrás e retomarei","o meu trigo no seu tempo","e o meu vinho novo na sua estação;","tirarei a minha lã e o meu linho,","que cobriam a sua nudez,"],np:1},
{v:12,l:["e agora descobrirei a sua vergonha","diante dos olhos dos seus amantes,","e ninguém a livrará da minha mão."],np:1},
{v:13,l:["Farei cessar toda a sua alegria,","as suas festas, as suas luas novas,","os seus sábados e todas as suas solenidades;"],np:1},
{v:14,l:["devastarei a sua videira e a sua figueira,","das quais dizia: São o pagamento","que me deram os meus amantes.","Farei delas um matagal,","e os animais do campo as devorarão."],np:1},
{v:15,l:["Eu a castigarei pelos dias dos baals,","em que lhes queimava incenso,","se enfeitava com os seus brincos e os seus colares","e ia atrás dos seus amantes,","mas de mim se esquecia,","oráculo do Senhor."],np:1},
{s:"O Senhor reconquista a esposa"},
{v:16,l:["Por isso eis que vou seduzi-la,","levá-la ao deserto","e falar-lhe ao coração;"]},
{v:17,l:["ali lhe devolverei as suas vinhas","e farei do vale de Acor uma porta de esperança;","ali ela responderá","como nos dias da sua juventude,","como no dia em que subiu da terra do Egito."],np:1,n:"Acor significa desgraça (Josué 7,24–26): o lugar da desgraça se torna porta de esperança."},
{v:18,l:["Naquele dia,","oráculo do Senhor,","tu me chamarás: Meu marido,","e não me chamarás mais: Meu Baal."],np:1,n:"Baal significa também senhor e marido; o nome, ligado ao deus cananeu, será abandonado."},
{v:19,l:["Tirarei da sua boca os nomes dos baals,","e o seu nome não será mais lembrado."],np:1},
{v:20,l:["Naquele dia farei em favor deles uma aliança","com os animais do campo, as aves do céu e os répteis da terra;","quebrarei o arco, a espada e a guerra","e os eliminarei da terra,","e os farei repousar em segurança."],np:1},
{v:21,l:["Eu te desposarei para sempre;","eu te desposarei na justiça e no direito,","no amor e na ternura."],np:1},
{v:22,l:["Eu te desposarei na fidelidade,","e conhecerás o Senhor."],np:1},
{v:23,l:["Naquele dia eu responderei,","oráculo do Senhor,","responderei ao céu,","e ele responderá à terra;"],np:1},
{v:24,l:["a terra responderá","ao trigo, ao vinho novo e ao azeite,","e eles responderão a Jezrael."],np:1},
{v:25,l:["Eu a semearei para mim na terra","e terei compaixão de Sem-Misericórdia;","e direi a Não-Meu-Povo: Tu és o meu povo,","e ele dirá: Tu és o meu Deus."],np:1}
];

window.TEXTOS_SEED["oseias"][3] = [
{s:"O profeta resgata a mulher adúltera"},
{v:1,t:"O Senhor me disse: Vai ainda, ama uma mulher amada por outro e adúltera, assim como o Senhor ama os filhos de Israel, embora eles se voltem para outros deuses e gostem dos bolos de passas.",n:"Os bolos de passas eram oferecidos nos cultos pagãos."},
{v:2,t:"Eu a comprei por quinze siclos de prata e um ômer e meio de cevada.",np:1},
{v:3,t:"E lhe disse: Durante muitos dias ficarás em casa esperando por mim; não te prostituirás nem serás de nenhum homem; e eu também não irei a ti.",np:1},
